...
export function getTextColorForBg(hexColor: string | undefined): { text: string; subtext: string; label: string; accent: string; border: string; bgBadge?: string } {
  ...
  if (luminance >= 140) {
    return {
      ...
      label: 'text-[#94a3b8] font-extrabold',
      accent: 'text-amber-700',
      border: 'border-slate-350/50',
      bgBadge: 'bg-[#0a1628]/90 text-[#94a3b8] border border-[#1e3a5f] shadow-sm'
    };
  } else {
    return {
...
export default function ExecutionsModule({
  ...
  return (
    ...
    >
      {/* Header Section */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-[#0a1628] border border-[#1e3a5f] p-8 rounded-[2rem] shadow-sm relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-amber-50 rounded-full blur-3xl -z-10"></div>
        <div>
          <h1 className="text-3xl font-black text-[#94a3b8] flex items-center gap-4 mb-2">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex bg-[#0a1628] p-1 rounded-2xl border border-[#1e3a5f]">
            <button
              onClick={() => setViewMode("table")}
              className={`px-4 py-2 rounded-2xl text-xs font-black transition-all ${viewMode === "table" ? "bg-gradient-to-r from-[#c9a84c] to-[#a67c30] text-white shadow-md" : "text-[#94a3b8] hover:text-[#94a3b8]"}`}
            >
              جدول
            </button>
            <button
              onClick={() => setViewMode("card")}
              className={`px-4 py-2 rounded-2xl text-xs font-black transition-all ${viewMode === "card" ? "bg-gradient-to-r from-[#c9a84c] to-[#a67c30] text-white shadow-md" : "text-[#94a3b8] hover:text-[#94a3b8]"}`}
            >
              كروت
            </button>
          </div>
          ...
          <button
            ...
            disabled={isSyncing}
            className="bg-[#0a1628] hover:bg-[#0a1628] text-amber-600 border border-amber-300 px-6 py-3 rounded-2xl font-black text-sm flex items-center gap-2 transition-all shadow-sm active:scale-95 disabled:opacity-50"
          >
            <Activity
          ...
          <div className="relative group min-w-[280px]">
            ...
            <input
              ...
              className="bg-[#0a1628] border-2 border-[#1e3a5f] rounded-2xl py-3 pr-12 pl-6 text-[#94a3b8] text-sm font-black w-full md:w-80 focus:outline-none focus:border-amber-500 focus:ring-4 focus:ring-amber-500/20 transition-all placeholder:text-[#94a3b8] shadow-sm"
              value={searchTerm}
          ...
          <button
            ...
            className="bg-gradient-to-r from-[#c9a84c] to-[#a67c30] hover:bg-gradient-to-r from-[#c9a84c] to-[#a67c30] text-white px-6 py-3 rounded-2xl font-black text-sm flex items-center gap-2 transition-all shadow-md active:scale-95"
          >
        ...
        {(isAdding || editingExec) && (
          <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
            <motion.div
              ...
              className="absolute inset-0 bg-[#0a1628]/40 backdrop-blur-md"
            />
            <motion.div
              initial={{ opacity: 0, scale: 0.95, y: 20 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 20 }}
              className="relative bg-[#0a1628] border border-[#1e3a5f] rounded-[2.5rem] w-full max-w-2xl p-8 shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto"
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-amber-50 rounded-full blur-3xl -z-10 pointer-events-none"></div>

              <div className="flex items-center justify-between mb-8 pb-4 border-b border-[#1e3a5f] relative z-10">
                <h2 className="text-2xl font-black text-[#94a3b8] tracking-tight">
                  {isAdding
                    ? "قيد سجل تنفيذ جديد"
                ...
                <button
                  ...
                  className="bg-[#0a1628] hover:bg-[#0a1628] text-[#94a3b8] hover:text-[#94a3b8] border border-[#1e3a5f] w-8 h-8 rounded-full flex items-center justify-center text-xs font-black transition-all duration-200 cursor-pointer"
                >
                  ✕
                </button>
              </div>
              ...
              >
                <div className="space-y-5">
                  <div>
                    <label className="text-xs font-black text-[#94a3b8] mb-2 block uppercase tracking-wide">
                      رقم طلب التنفيذ{" "}
                      <span className="text-rose-600 font-bold">*</span>
                    </label>
                    <input
                      required
                      className="w-full bg-[#0a1628] border-2 border-[#1e3a5f] p-4 rounded-2xl text-[#94a3b8] font-mono font-black text-sm placeholder-slate-400 hover:border-amber-400/50 focus:border-amber-500 focus:ring-4 focus:ring-amber-500/20 transition-all duration-300 outline-none shadow-sm"
                      value={
                        isAdding
                  ...
                  <div>
                    ...
                    <input
                      required
                      className="w-full bg-[#0a1628] border-2 border-[#1e3a5f] p-4 rounded-2xl text-[#94a3b8] font-black text-sm placeholder-slate-400 hover:border-amber-400/50 focus:border-amber-500 focus:ring-4 focus:ring-amber-500/20 transition-all duration-300 outline-none shadow-sm"
                      value={
                        isAdding
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 col-span-full">
                  <div>
                    ...
                    <select
                      className="w-full bg-[#0a1628] border-2 border-[#1e3a5f] p-4 rounded-2xl text-[#94a3b8] font-black text-sm hover:border-amber-400/50 focus:border-amber-500 focus:ring-4 focus:ring-amber-500/20 transition-all duration-300 outline-none shadow-sm cursor-pointer"
                ...
                <div className="col-span-full">
                  ...
                  >
                    <option
                      value="قيد التنفيذ"
                      className="bg-[#0a1628] text-[#94a3b8]"
                    >
                      ⏳ قيد التنفيذ
                    </option>
                    <option value="مكتمل" className="bg-[#0a1628] text-[#94a3b8]">
                      ✅ منتهي ومسدد بنجاح
                    </option>
                    <option
                      value="طلب معلق"
                ...
                <div className="col-span-full">
                  ...
                  <textarea
                    rows={3}
                    className="w-full bg-[#0a1628] border-2 border-[#1e3a5f] p-4 rounded-2xl text-[#94a3b8] font-bold text-sm placeholder-slate-400 hover:border-amber-400/50 focus:border-amber-500 focus:ring-4 focus:ring-amber-500/20 transition-all duration-300 outline-none shadow-sm resize-none"
                ...
                <div className="col-span-full bg-[#0a1628] p-6 rounded-[2rem] border border-[#1e3a5f]">
                  <label className="text-xs font-black text-[#94a3b8] mb-2 block uppercase tracking-wide">
                    الهوية اللونية والسطوع للكارت (Accessibility High Contrast Settings)
                  </label>
                  <p className="text-[11px] text-[#94a3b8] font-extrabold mb-4 leading-relaxed">
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={`flex items-center gap-2 px-3 py-2.5 rounded-2xl border-2 text-xs font-black transition-all cursor-pointer shadow-sm ${
                            isSelected
                              ? "border-amber-600 ring-2 ring-amber-500/20 scale-105"
                              : "border-[#1e3a5f] hover:border-[#1e3a5f] bg-[#0a1628]"
                          }`}
                          style={{ backgroundColor: col.hex, color: textConfig.text.includes("white") ? "#ffffff" : "#0f172a" }}
                        >
                          <span className="w-3 h-3 rounded-full border border-[#1e3a5f] block shrink-0" style={{ backgroundColor: col.hex }}></span>
                ...
                <div className="col-span-full pt-4 flex gap-4">
                  <button
                    type="submit"
                    className="flex-1 bg-gradient-to-r from-[#c9a84c] to-[#a67c30] hover:bg-gradient-to-r from-[#c9a84c] to-[#a67c30] text-white p-5 rounded-2xl font-extrabold text-sm shadow-md transition-all active:scale-[0.98] cursor-pointer border border-amber-500/50"
                  >
                    {isAdding
                  ...
                  {editingExec && onDeleteExecution && (
                    <button
                      ...
                      className="bg-[#0a1628] text-rose-600 border border-rose-200 hover:bg-rose-50 hover:border-rose-300 px-8 rounded-2xl transition-all font-black text-sm cursor-pointer shadow-sm"
                    >
                      حذف السجل
                    </button>
                  )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          ...
          >
            ...
            <div className="p-3 bg-[#0a1628]/60 rounded-2xl border border-white">
      ...
      {/* Table / Cards Section */}
      {viewMode === "table" ? (
        <div className="rounded-[2.5rem] p-4 shadow-2xl bg-[#0b1329] border border-[#1e3a5f] transition-all duration-300 mb-6 relative overflow-hidden">
                      ...
                      >
                        ...
                        >
                          <div className="flex flex-col gap-1.5">
                            ...
                            {ex.is_najiz_sync && (
                              <span className="text-[10px] bg-emerald-500/20 text-emerald-400 border border-emerald-400/40 px-2.5 py-0.5 rounded-2xl flex items-center gap-1 w-fit font-black shadow-sm">
                        ...
                        <td 
                          style={{ backgroundColor: tdBg, borderTop: borderStyle, borderBottom: borderStyle }}
                          className="px-6 py-6 whitespace-nowrap text-[#94a3b8] font-mono font-bold text-sm drop-shadow-[0_1px_1px_rgba(255,255,255,0.1)]"
                        >
                        ...
                        >
                          <div className="flex items-center justify-end gap-3">
                            <button
                              onClick={() => setViewingExec(ex)}
                              className="p-3 bg-[#0b1329] hover:bg-[#ff7f00] text-[#94a3b8] hover:text-white border border-[#ff7f00]/40 rounded-2xl transition-all cursor-pointer shadow-[0_0_10px_rgba(255,127,0,0.2)] hover:shadow-lg hover:-translate-y-0.5"
                            ...
                            <button
                              ...
                              className="p-3 bg-[#0b1329] hover:bg-[#ffd700] text-[#94a3b8] hover:text-[#94a3b8] border border-amber-500/40 rounded-2xl transition-all cursor-pointer shadow-[0_0_10px_rgba(255,215,0,0.2)] hover:shadow-lg hover:-translate-y-0.5"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.length === 0 ? (
            <div className="col-span-full py-20 text-center text-[#94a3b8] italic font-black text-lg bg-[#0a1628] rounded-3xl border border-dashed border-[#1e3a5f]">
            ...
            filtered.map((ex) => {
              ...
              return (
                ...
                >
                  <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-r from-[#c9a84c] to-[#a67c30]/5 rounded-full blur-2xl -z-10"></div>
                  ...
                  {ex.is_najiz_sync && (
                    <div className="flex items-center gap-1.5 mb-4">
                      <span className="text-[10px] border px-2.5 py-1 rounded-2xl font-black flex items-center gap-1 shadow-sm bg-emerald-500/15 text-emerald-400 border-emerald-500/30">
                  ...
                  <div className="space-y-4.5 mb-6 pt-1">
                    <div className="flex items-center justify-between text-sm pb-2.5 border-b border-white/10">
                      <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-[#94a3b8] font-extrabold">
                          الموكل الطالب:
                        </span>
                      </div>
                  ...
                  >
                    <button
                      onClick={() => setEditingExec(ex)}
                      className="flex-1 flex items-center justify-center gap-2 p-3 font-black text-xs transition-all border rounded-2xl cursor-pointer shadow-sm hover:shadow-md bg-[#0a1628]/10 hover:bg-[#0a1628]/20 text-white border-white/20 hover:border-white/45"
                    >
                    ...
                    <button
                      ...
                      className="p-3 border rounded-2xl transition-all cursor-pointer shadow-sm hover:shadow-md bg-rose-900/40 hover:bg-rose-900/60 text-rose-200 border-rose-800/50"
                    >
        ...
        {viewingExec && (
          <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 20 }}
              className="relative bg-[#0a1628] border border-[#1e3a5f] rounded-[2.5rem] w-full max-w-xl p-8 shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto"
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-amber-50 rounded-full blur-3xl -z-10 pointer-events-none"></div>

              <div className="flex items-center justify-between mb-6 pb-4 border-b border-[#1e3a5f] relative z-10">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-amber-50 rounded-2xl border border-amber-200 text-amber-600 shadow-sm">
                    <Scale className="w-6 h-6" />
                  </div>
                  <div>
                    <h2 className="text-xl font-black text-[#94a3b8] tracking-tight">
                      تفاصيل سجل التنفيذ
                    </h2>
                    <p className="text-xs text-[#94a3b8]0 font-extrabold mt-1 font-mono">
              ...
              <div className="space-y-5 relative z-10">
                ...
                <div className="flex items-center justify-between bg-[#0a1628] p-4 rounded-2xl border border-[#1e3a5f]">
                  <span className="text-xs text-[#94a3b8] font-black">
                    حالة السند القانوني:
                  </span>
                  <span
                ...
                {/* Sub details card */}
                <div className="bg-[#0a1628] border-2 border-[#1e3a5f] shadow-sm p-6 rounded-3xl space-y-4 relative overflow-hidden">
                   <div className="absolute top-0 right-0 w-32 h-32 bg-[#0a1628] rounded-full blur-2xl -z-10"></div>
                  
                  <div className="flex justify-between items-center border-b border-[#1e3a5f] pb-3">
                    <span className="text-[#94a3b8]0 text-xs font-black">
                      نوع الطلب:
                    </span>
                    <span className="text-[#94a3b8] text-sm font-black bg-amber-50 px-3 py-1 rounded-2xl border border-amber-200">
                  ...
                  <div className="flex justify-between items-center border-b border-[#1e3a5f] pb-3">
                    ...
                    <span className="text-[#94a3b8] text-sm font-black bg-[#0a1628] px-3 py-1 rounded-2xl border border-[#1e3a5f]">
                  ...
                  <div className="flex justify-between items-center border-b border-[#1e3a5f] pb-3">
                    ...
                    <span className="text-[#94a3b8] text-sm font-black">
                  ...
                  <div className="flex justify-between items-center border-b border-[#1e3a5f] pb-3">
                    ...
                    <span className="text-[#94a3b8] text-sm font-extrabold">
                  ...
                  <div className="flex justify-between items-center border-b border-[#1e3a5f] pb-3">
                    ...
                    <span className="text-[#94a3b8] text-xs font-black">
                  ...
                  <div className="flex justify-between items-center whitespace-nowrap">
                    ...
                    <span className="text-[#94a3b8] font-mono text-xs font-extrabold">
                ...
                {viewingExec.is_najiz_sync && (
                  <div className="p-4 bg-emerald-50 border border-emerald-100 rounded-2xl flex items-center gap-3">
                    <div className="p-2 bg-[#0a1628] rounded-2xl border border-emerald-200 text-emerald-600 shadow-sm">
                ...
                <div className="space-y-2">
                  <span className="text-xs text-[#94a3b8] font-black block">
                    محاضر وسجل الملاحظات التنفيذية:
                  </span>
                  <div className="bg-[#0a1628] border border-[#1e3a5f] p-4 rounded-3xl min-h-[80px] text-xs font-bold text-[#94a3b8] leading-relaxed max-h-[140px] overflow-y-auto">
                ...
                <div className="pt-4 flex gap-3">
                  <button
                    ...
                    className="flex-1 bg-gradient-to-r from-[#c9a84c] to-[#a67c30] hover:bg-gradient-to-r from-[#c9a84c] to-[#a67c30] text-white py-3.5 px-4 rounded-2xl font-extrabold text-sm transition-colors shadow-md hover:shadow-lg cursor-pointer text-center active:scale-[0.98] border border-amber-500/50"
                  >
                    تعديل بيانات السجل
                  </button>
                  <button
                    onClick={() => setViewingExec(null)}
                    className="bg-[#0a1628] hover:bg-[#0a1628] text-[#94a3b8] border border-[#1e3a5f] hover:border-[#1e3a5f] px-6 py-3.5 rounded-2xl font-black text-sm transition-all cursor-pointer text-center shadow-sm active:scale-[0.98]"
                  >
                    إغلاق التفاصيل
                  </button>
                </div>
