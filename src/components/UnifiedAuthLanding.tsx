...
export default function UnifiedAuthLanding({ initialTab = "lawyer", language = "ar", onLoginSuccess, onBackToHome }: UnifiedAuthProps) {
  ...
  useEffect(() => {
    ...
    const performAutoLogin = async (session: any) => {
      try {
        const { data: profile } = await supabase.from('profiles').select('id, uid, full_name, role, permissions, email, phone').eq('uid', session.user.id).single();
        if (profile) {
          onLoginSuccess({
  ...
  const handleLawyerSignInSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        const { data: profile } = await supabase.from('profiles').select('id, uid, full_name, role, permissions, email, phone').eq('uid', user.id).maybeSingle();
        if (!profile) {
          userData = {
            uid: user.id,
  ...
  const handleEmployeeLoginSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data: employeeRecords, error } = await supabase
        .from('employees')
        .select('id, name, username, password, employee_code, job_title, assigned_cases, assigned_clients, sidebar_config')
  ...
  return (
    <div className="flex min-h-screen bg-[#FAFAFA] text-slate-950 font-black tracking-tight font-sans" dir="rtl">
      ...
      */}
      <div className="hidden lg:flex flex-col w-[450px] bg-white/80 backdrop-blur-sm border-l border-[#D4AF37]/50/40 p-10 relative overflow-y-auto shadow-2xl z-10">
        ...
        <div className="relative z-10 flex flex-col h-full gap-8">
          ...
          <div className="space-y-6 mt-4">
            <div className="bg-[#FAFAFA]/95 border-2 border-[#D4AF37]/50/40 hover:border-[#D4AF37]/50 hover:shadow-2xl shadow-[#D4AF37]/20 p-5 rounded-3xl transition-all duration-300 shadow-xl group">
              <div className="flex items-center gap-3 mb-3">
                <div className="bg-[#D4AF37]/10 p-2.5 rounded-xl border border-[#D4AF37]/50">
                  <RefreshCw className="w-5 h-5 text-[#B8860B] group-hover:rotate-180 transition-transform duration-700" />
                </div>
                <h3 className="font-black tracking-tight text-[#B8860B] text-base">مزامنة ذكية مع وزارة العدل</h3>
               </div>
              <p className="text-xs text-slate-800 font-bold font-semibold leading-relaxed text-justify">
            ...
            <div className="bg-[#FAFAFA]/95 border-2 border-[#D4AF37]/50/40 hover:border-[#D4AF37]/50 hover:shadow-2xl shadow-[#D4AF37]/20 p-5 rounded-3xl transition-all duration-300 shadow-xl group">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-black tracking-tight text-[#B8860B] text-base">إدارة الأصول والكيانات المستقلة</h3>
              </div>
              <p className="text-xs text-slate-800 font-bold font-semibold leading-relaxed text-justify">
            ...
            <div className="bg-[#FAFAFA]/95 border-2 border-[#D4AF37]/50/40 hover:border-[#D4AF37]/50 hover:shadow-2xl shadow-[#D4AF37]/20 p-5 rounded-3xl transition-all duration-300 shadow-xl group">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-black tracking-tight text-[#B8860B] text-base">التحليل المالي ورقابة الميزانيات</h3>
              </div>
              <p className="text-xs text-slate-800 font-bold font-semibold leading-relaxed text-justify">
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 relative bg-[#FAFAFA]">
        ...
        <div className="w-full max-w-2xl bg-white/95 backdrop-blur-2xl border-2 border-[#D4AF37]/50 rounded-[2.5rem] p-8 lg:p-10 space-y-7 relative z-10 shadow-2xl shadow-amber-900/5">
              ...
              <form onSubmit={handlePhoneSignIn} className="space-y-3">
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-white/80 backdrop-blur-sm border border-[#D4AF37]/50 focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37]/30 text-slate-950 font-black tracking-tight text-sm font-black tracking-tight py-4 px-5 rounded-xl focus:outline-none transition-all text-center placeholder:text-slate-500 font-bold font-mono shadow-inner tracking-widest"
                  />
                  <Smartphone className="w-5 h-5 text-[#B8860B] absolute left-4 top-4" />
                </div>
                <button
                  type="submit"
                  disabled={loading}
              ...
              <form onSubmit={handleVerifyPhoneOtp} className="space-y-3">
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-white/80 backdrop-blur-sm border border-[#D4AF37]/50 focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37]/30 text-[#B8860B] text-2xl font-black tracking-tight py-4 px-5 rounded-xl focus:outline-none transition-all text-center tracking-[0.5em] placeholder:text-slate-500 font-bold shadow-inner"
                  />
                </div>
                <button
                  type="submit"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-white/80 backdrop-blur-sm border border-[#D4AF37]/50 focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37]/30 rounded-xl px-5 py-4 text-sm text-slate-950 font-black tracking-tight placeholder:text-slate-500 font-bold focus:outline-none pr-12 transition-all font-black tracking-tight shadow-inner"
                    />
                    <Mail className="w-5 h-5 text-[#B8860B] absolute right-4 top-4" />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-white/80 backdrop-blur-sm border border-[#D4AF37]/50 focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37]/30 rounded-xl px-5 py-4 text-sm text-slate-950 font-black tracking-tight placeholder:text-slate-500 font-bold focus:outline-none pr-12 transition-all font-black tracking-tight shadow-inner tracking-widest"
                    />
                    <Lock className="w-5 h-5 text-[#B8860B] absolute right-4 top-4" />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-white/80 backdrop-blur-sm border border-[#D4AF37]/50 focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37]/30 rounded-xl px-5 py-4 text-sm text-slate-950 font-black tracking-tight placeholder:text-slate-500 font-bold focus:outline-none text-center font-mono transition-all font-black tracking-tight shadow-inner pr-12"
                    />
                    <User className="w-5 h-5 text-[#B8860B] absolute right-4 top-4" />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-white/80 backdrop-blur-sm border border-[#D4AF37]/50 focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37]/30 rounded-xl px-5 py-4 text-sm text-slate-950 font-black tracking-tight placeholder:text-slate-500 font-bold focus:outline-none text-center font-mono transition-all font-black tracking-tight shadow-inner tracking-widest pr-12"
                    />
                    <Lock className="w-5 h-5 text-[#B8860B] absolute right-4 top-4" />
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-white/80 backdrop-blur-sm border border-[#D4AF37]/50 focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37]/30 rounded-xl px-5 py-4 text-sm text-slate-950 font-black tracking-tight placeholder:text-slate-500 font-bold focus:outline-none pr-12 transition-all font-black tracking-tight shadow-inner font-mono text-left"
                        dir="ltr"
                      />
                      <Smartphone className="w-5 h-5 text-[#B8860B] absolute right-4 top-4" />
                    </div>
                  </div>
                )}
